...
const AdminRoot = () => {
  ...
  if (!authorized) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[#0f170a] text-white p-6 text-center">
        <h1 className="text-2xl font-black mb-2 text-red-500 uppercase italic">
          Access Denied
        </h1>
        ...
        <button
          ...
          className="bg-white text-black px-8 py-3 rounded-xl font-black uppercase text-xs tracking-widest shadow-xl active:scale-95 transition-transform"
        >
          Return to App
        </button>
      </div>
  ...
  return (
    <ErrorBoundary
      fallback={
        <div className="fixed inset-0 z-150 bg-red-800 flex items-center justify-center text-white text-2xl font-black italic uppercase">
          Admin application crashed! Please refresh.
        </div>
      }
    >
      <AdminDashboard
