...
export default function Header({ onShowRules }: Props) {
  return (
    <header className="flex items-center justify-between p-4 sticky top-0 bg-transparent z-50 shrink-0">
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 bg-indigo-950 border border-white/20 flex items-center justify-center text-white font-black rounded-lg shadow-lg">L</div>
